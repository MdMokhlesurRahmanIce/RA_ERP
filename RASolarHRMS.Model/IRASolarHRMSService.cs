...
{
    public interface IRASolarHRMSService
    {
        ...
        string SaveTrainingAssesmentEntry(string prmLocationCode, string ddlIdNo, string empEvType, string empEvKal, string trainingDate, string assesmentDate, string prmIsAssessmentCompleted, string txtUnitManagerMontobbo, string chkbxVal, string aprovedDate, string crArrID, string crArrScore, string weight, string pPurboPNo, string prmIsAssessmentSelectedByERPData, string userLogin, string insertData, string rowWiseRemarks); 
        ...
        List<BankAdviceForSalaryLatterReport> ReadBankAdviceForSalaryLatterReport(string OCT_End_CDODCUSTOMERS);

        List<LatterToChairmanReport> ReadLatterToChairmanReport(string OCT_End_CDODCUSTOMERS);

        List<LatterToUpoZelaChairmanReport> ReadLatterToUpoZelaChairmanReport(string OCT_End_CDODCUSTOMERS);
