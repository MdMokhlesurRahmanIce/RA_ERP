...
namespace RASolarERP.Model
{
    ...
    public partial class Sal_CustomerOccupations
    {
        public Sal_CustomerOccupations()
        {
            this.Sal_Customer = new HashSet<Sal_Customer>();
            this.Sal_CustomerPrePost = new HashSet<Sal_CustomerPrePost>();
        }
    
        public string CustomerOccupationID { get; set; }
        public string Description { get; set; }
        public byte SortingOrder { get; set; }
        public Nullable<decimal> IDCOLOccupationID { get; set; }
        public string IDCOLOccupationName { get; set; }
